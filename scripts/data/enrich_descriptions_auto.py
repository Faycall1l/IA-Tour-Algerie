...
WILAYA_DESCRIPTIONS = {
    ...
    "In Salah": "Aïn Salah est une oasis du Sahara central, ancienne étape caravanière entre le nord et l'Afrique subsaharienne. La région est célèbre pour ses foggaras, systèmes d'irrigation souterrains.",
    "In Guezzam": "Aïn Guezzam est la porte du Ténéré algérien, à la frontière du Niger. C'est la porte sud du Sahara algérien, point de départ vers les immensités désertiques.",
    ...
    "Aïn Ouessara": "Aïn Oussera est une ville des hauts plateaux, dans la wilaya de Djelfa. C'est un carrefour important entre le nord et le sud.",
