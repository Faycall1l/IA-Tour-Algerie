...
registry.register(
    Prompt(
        ...
        template=(
            ...
            "\n|------|----------|-----------------|"
            "\n| search_pois | User asks for specific places (beaches, museums, restaurants, etc.) | User asks for a general wilaya overview — use get_wilaya_guide instead |"  # noqa: E501
            "\n| search_stays | User asks about hotels, hostels, guesthouses, or accommodation | User asks about activities or sightseeing |"  # noqa: E501
            "\n| search_experiences | User asks about tours, workshops, hikes, or activities | User asks about static places — use search_pois instead |"  # noqa: E501
            "\n| search_artisans | User asks about local crafts, souvenirs, or artisan shops | User asks about general tourism |"  # noqa: E501
            "\n| get_wilaya_guide | User asks 'what to see/do' in ONE specific wilaya | Multi-wilaya queries — use get_transport_route for connections |"  # noqa: E501
            "\n| get_transport_route | User asks how to get BETWEEN two wilayas | Within-city transport — not supported |"  # noqa: E501
            "\n| get_operator_contacts | User asks for phone numbers or contact info for transport companies | General travel questions |"  # noqa: E501
            "\n| find_events | User asks about festivals, events, or seasonal activities | General sightseeing — use search_pois |"  # noqa: E501
            "\n| get_weather | User asks about weather or planning outdoor activities | Indoor activities or general planning |"  # noqa: E501
            ...
            "\n- For queries mentioning 3+ wilayas: call get_transport_route for each pair, then get_wilaya_guide for the MAIN destination only. Do NOT call search_pois/search_stays for each wilaya."  # noqa: E501
            "\n- For 'what to see in X': call get_wilaya_guide ONCE. Do NOT also call search_pois — the guide already includes top POIs."  # noqa: E501
            "\n- If you have already called 2 tools, synthesize your answer from what you have. Do NOT call a third unless strictly necessary."  # noqa: E501
            "\n\n## REASONING PROTOCOL"
            ...
            "\n- If the user's query is ambiguous: answer with your best interpretation, don't ask clarifying questions"  # noqa: E501
...
registry.register(
    Prompt(
        ...
        template=(
            ...
            "Given a destination, duration, budget, and interests, create a detailed day-by-day plan."  # noqa: E501
            "\n\nPLANNING RULES:"
            ...
            "\n4. Check transport between cities using `get_transport_route` if the trip spans multiple wilayas"  # noqa: E501
            ...
            "\n7. Balance each day: 1 major attraction (morning) + 1-2 smaller activities (afternoon) + dining (evening)"  # noqa: E501
...
registry.register(
    Prompt(
        ...
        template=(
            ...
            "\n\nYOUR CAPABILITIES:"
            "\n- Find transport routes between any two wilayas (train, bus, taxi, flight, multi-hop)"  # noqa: E501
...
class AgentContext:
    ...
    @classmethod
    def from_user(cls, user, _wilaya=None) -> AgentContext:
