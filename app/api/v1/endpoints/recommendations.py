...
@router.get(
    ...
    description="Personalized content-based recommendations (model cbf_v1) for the authenticated user, filtered by wilaya and entity type.",  # noqa: E501
    responses={
...
@router.get(
    ...
    description="The user's inferred travel preferences (categories, budgets). Auto-creates a default profile on first access.",  # noqa: E501
...
@router.post(
    ...
    description="Rebuild the user's preferences from their interaction history (favorites, collections, trips).",  # noqa: E501
    responses={401: {"description": "Authentication required"}},
)
...
@router.post(
    ...
    description="Record feedback on a recommendation: liked, dismissed, or bookmarked. Dismissed hides it; liked/bookmarked marks it seen.",  # noqa: E501
    responses={
        401: {"description": "Authentication required"},
